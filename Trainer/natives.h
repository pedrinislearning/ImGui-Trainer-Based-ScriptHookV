...
namespace 
{
	...
	static void DISPLAY_SYSTEM_SIGNIN_UI(ScrHandle MUSCLE) { invoke<Void>(0x94DD7888C10A979E, MUSCLE); } // 0x94DD7888C10A979E 0x4264CED2
	...
	static BOOL _0xE23D5873C2394C61(Player player) { return invoke<BOOL>(0xE23D5873C2394C61, player); } // 0xE23D5873C2394C61
	...
	static void _GET_PLAYER_PARACHUTE_SMOKE_COLOUR(Player player, int* r, int* g, int* b) { invoke<Void>(0xEF56DBABD3CD4887, player, r, g, b); } // 0xEF56DBABD3CD4887 0xF66E5CDD
	...
	static BOOL HAS_ENTITY_ANIM_FINISHED(Entity entity, char* Animdict, char* Anim, int p3) { return invoke<BOOL>(0x20B711662962B472, entity, Animdict, Anim, p3); } // 0x20B711662962B472 0x1D9CAB92
	...
	static float GET_ENTITY_ANIM_CURRENT_TIME(Entity entity, char* animDict, char* animation) { return invoke<float>(0x346D81500D088F42, entity, animDict, animation); } // 0x346D81500D088F42 0x83943F41
	static float GET_ENTITY_ANIM_TOTAL_TIME(Entity entity, char* animDict, char* animation) { return invoke<float>(0x50BD2730B191E360, entity, animDict, animation); } // 0x50BD2730B191E360 0x433A9D18
	static float _GET_ANIM_DURATION(char* animDict, char* animation) { return invoke<float>(0xFEDDF04D62B8D790, animDict, animation); } // 0xFEDDF04D62B8D790
	...
	static BOOL WOULD_ENTITY_BE_OCCLUDED(Hash model, float x, float y, float z, BOOL p4) { return invoke<BOOL>(0xEE5D2A122E09EC42, model, x, y, z, p4); } // 0xEE5D2A122E09EC42 0xEA127CBC
	...
	static void ATTACH_ENTITY_TO_ENTITY(Entity entity1, Entity entity2, int boneIndex, float x, float y, float z, float xRot, float yRot, float zRot, BOOL p9, BOOL isRel, BOOL ignoreUpVec, BOOL allowRotation, int unk, BOOL p14) { invoke<Void>(0x6B9BBD38AB0796DF, entity1, entity2, boneIndex, x, y, z, xRot, yRot, zRot, p9, isRel, ignoreUpVec, allowRotation, unk, p14); } // 0x6B9BBD38AB0796DF 0xEC024237
	static void ATTACH_ENTITY_TO_ENTITY_PHYSICALLY(Entity entity1, Entity entity2, int boneIndex, int boneIndex2, float x1, float y1, float z1, float x2, float y2, float z2, float xRot, float yRot, float zRot, float forceToBreak, BOOL p14, BOOL p15, BOOL p16, BOOL p17, int p18) { invoke<Void>(0xC3675780C92F90F9, entity1, entity2, boneIndex, boneIndex2, x1, y1, z1, x2, y2, z2, xRot, yRot, zRot, forceToBreak, p14, p15, p16, p17, p18); } // 0xC3675780C92F90F9 0x0547417F
	...
	static BOOL FIND_ANIM_EVENT_PHASE(char* animDict, char* animation, char* p2, Any* p3, Any* p4) { return invoke<BOOL>(0x07F1BE2BCCAA27A7, animDict, animation, p2, p3, p4); } // 0x07F1BE2BCCAA27A7 0xC41DDA62
	static void SET_ENTITY_ANIM_CURRENT_TIME(Ped ped, char* animdict, char* animName, float time) { invoke<Void>(0x4487C259F0F70977, ped, animdict, animName, time); } // 0x4487C259F0F70977 0x99D90735
	static void SET_ENTITY_ANIM_SPEED(Entity entityHandle, char* animationDiction, char* animationName, float speedMultiplier) { invoke<Void>(0x28D1A16553C51776, entityHandle, animationDiction, animationName, speedMultiplier); } // 0x28D1A16553C51776 0x3990C90A
	...
	static void SET_ENTITY_TRAFFICLIGHT_OVERRIDE(Entity entity, BOOL toggle) { invoke<Void>(0x57C5DB656185EAC4, entity, toggle); } // 0x57C5DB656185EAC4 0xC47F5B91
	...
	static void SET_SCRIPTED_CONVERSION_COORD_THIS_FRAME(Any p0, Any p1, Any p2) { invoke<Void>(0x5086C7843552CF85, p0, p1, p2); } // 0x5086C7843552CF85 0x25EA2AA5
	...
	static BOOL CAN_PED_IN_COMBAT_SEE_TARGET(Ped ped, Ped target) { return invoke<BOOL>(0xEAD42DE3610D0721, target, target); } // 0xEAD42DE3610D0721 0xCCD525E1
	...
	static void SET_PED_TO_INFORM_RESPECTED_FRIENDS(Ped ped, float p1, Any p2) { invoke<Void>(0x112942C6E708F70B, ped, p1, p2); } // 0x112942C6E708F70B 0xD78AC46C
	...
	static void SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE(Ped ped, BOOL state) { invoke<Void>(0x7A6535691B477C48, ped, state); } // 0x7A6535691B477C48 0x8A251612
	...
	static void SET_CAN_ATTACK_FRIENDLY(Ped playerPed, BOOL toggle, BOOL p2) { invoke<Void>(0xB3B1CB349FF9C75D, playerPed, toggle, p2); } // 0xB3B1CB349FF9C75D 0x47C60963
	...
	static Ped GET_LAST_PED_IN_VEHICLE_SEAT(Vehicle vehicle, Any p1) { return invoke<Ped>(0x83F969AA1EE2A664, vehicle, p1); } // 0x83F969AA1EE2A664 0xF7C6792D
	...
	static void _0x374706271354CB18(Vehicle* p0, Player* p1, Object* p2) { invoke<Void>(0x374706271354CB18, p0, p1, p2); } // 0x374706271354CB18 0x40C4763F
	...
	static void ATTACH_VEHICLE_TO_TOW_TRUCK(Vehicle towTruck, Vehicle vehicle, int p2, float x, float y, float z) { invoke<Void>(0x29A16F8D621C4508, towTruck, vehicle, p2, x, y, z); } // 0x29A16F8D621C4508 0x8151571A
	...
	static void SET_VEHICLE_SEARCHLIGHT(Vehicle vehicle, BOOL p1, BOOL p2) { invoke<Void>(0x14E85C5EE7A4D542, vehicle, p1, p2); } // 0x14E85C5EE7A4D542 0xE2C0DD8A
	...
	static char* GET_LIVERY_NAME(Any p0, Any p1) { return invoke<char*>(0xB4C7A93837C91A1F, p0, p1); } // 0xB4C7A93837C91A1F 0xED80B5BE
	...
	static void _ENABLE_CARGOBOB_HOOK(BOOL state) { invoke<Void>(0x7BEB0C7A235F6F3B, state); } // 0x7BEB0C7A235F6F3B 0x4D3C9A99
	...
	static Object GET_CLOSEST_OBJECT_OF_TYPE(float x, float y, float z, float radius, Hash modelHash, Any p5, Any p6, Any p7) { return invoke<Object>(0xE143FA2249364369, x, y, z, radius, modelHash, p5, p6, p7); } // 0xE143FA2249364369 0x45619B33
	...
	static Any CREATE_PORTABLE_PICKUP(Hash pickupHash, float x, float y, float z, BOOL p4, Any p5) { return invoke<Any>(0x2EAF1FDB2FB55698, pickupHash, x, y, z, p4, p5); } // 0x2EAF1FDB2FB55698 0x8C886BE5
	static Object _0x125494B98A21AAF7(Hash objectModel, float x, float y, float z, BOOL p4, Hash objectModel2) { return invoke<Object>(0x125494B98A21AAF7, objectModel, x, y, z, p4, objectModel2); } // 0x125494B98A21AAF7 0x56A02502
	...
	static void TASK_PAUSE(Ped ped, Any p1) { invoke<Void>(0xE73A266DB0CA9042, ped, p1); } // 0xE73A266DB0CA9042 0x17A64668
	...
	static void _TASK_GET_OFF_BOAT(Any p0, Any p1) { invoke<Void>(0x9C00E77AF14B2DFF, p0, p1); } // 0x9C00E77AF14B2DFF
	...
	static void TASK_PLAY_PHONE_GESTURE_ANIMATION(Any p0, Any* p1, Any* p2, Any* p3, float p4, float p5, BOOL p6, BOOL p7) { invoke<Void>(0x8FBB6758B3B3E9EC, p0, p1, p2, p3, p4, p5, p6, p7); } // 0x8FBB6758B3B3E9EC 0x1582162C
	...
	static Any GET_SEQUENCE_PROGRESS(Ped ped) { return invoke<Any>(0x00A9010CFE1E3533, ped); } // 0x00A9010CFE1E3533 0xA3419909
	...
	static void TASK_VEHICLE_HELI_PROTECT(Ped pilot, Vehicle vehicle, Ped pedToFollow, float targetSpeed, Any p4, float radius, Any p6, Any p7) { invoke<Void>(0x1E09C32048FEFD1C, pilot, vehicle, pedToFollow, targetSpeed, p4, radius, p6, p7); } // 0x1E09C32048FEFD1C 0x0CB415EE
	static void SET_TASK_VEHICLE_CHASE_BEHAVIOR_FLAG(Any p0, Any p1, BOOL p2) { invoke<Void>(0xCC665AAC360D31E7, p0, p1, p2); } // 0xCC665AAC360D31E7 0x2A83083F
	...
	static void TASK_PLANE_MISSION(Ped Pilot, Vehicle Aeroplane, int targetVehicle, int target, float DestinationX, float DestinationY, float DestinationZ, int p7, float physicsSpeed, float p9, float p10, float p11, float patrolBlend) { invoke<Void>(0x23703CD154E83B88, Pilot, Aeroplane, targetVehicle, target, DestinationX, DestinationY, DestinationZ, p7, physicsSpeed, p9, p10, p11, patrolBlend); } // 0x23703CD154E83B88 0x1D007E65
	static void TASK_BOAT_MISSION(Any p0, Any p1, Any p2, Any p3, float x, float y, float z, Any p7, float speed, Any p9, float p10, Any p11) { invoke<Void>(0x15C86013127CE63F, p0, p1, p2, p3, x, y, z, p7, speed, p9, p10, p11); } // 0x15C86013127CE63F 0x5865B031
	...
	static void SET_MOUNTED_WEAPON_TARGET(Any p0, Any p1, Any p2, float p3, float p4, float p5) { invoke<Void>(0xCCD892192C6D2BB9, p0, p1, p2, p3, p4, p5); } // 0xCCD892192C6D2BB9 0x98713C68
	...
	static void TASK_WRITHE(Ped ped, Ped target, int timeOut, BOOL p3) { invoke<Void>(0xCDDC2B77CE54AC6E, ped, target, timeOut, p3); } // 0xCDDC2B77CE54AC6E 0x0FDC54FC
	...
	static void _0xE3A7742E0B7A2F8B(float x1, float y1, float z1, float x2, float y2, float z2, int damage, BOOL p7, Hash weaponHash, Ped ownerPed, BOOL isAudible, BOOL p11, Entity p12, Any p13) { invoke<Void>(0xE3A7742E0B7A2F8B, x1, y1, z1, x2, y2, z2, damage, p7, weaponHash, ownerPed, isAudible, p11, p12, p13); } // 0xE3A7742E0B7A2F8B 0x52ACCB7B
	...
	static BOOL CREATE_INCIDENT(int* incidentType, float x, float y, float z, int* p4, float radius, int* incidentId) { return invoke<BOOL>(0x3F892CAF67444AE7, incidentType, x, y, z, p4, radius, incidentId); } // 0x3F892CAF67444AE7 0xFC5FF7B3
	...
	static void ENABLE_TENNIS_MODE(Ped ped, BOOL p1, BOOL p2) { invoke<Void>(0x28A04B411933F8A6, ped, p1, p2); } // 0x28A04B411933F8A6 0x0BD3F9EC
	...
	static void START_CUTSCENE(char* cutsceneName) { invoke<Void>(0x186D5CB5E7B0FF7B, cutsceneName); } // 0x186D5CB5E7B0FF7B 0x210106F6
	static void START_CUTSCENE_AT_COORDS(char* cutsceneName, float x, float y, float z) { invoke<Void>(0x1C9ADDA3244A1FBF, cutsceneName, x, y, z); } // 0x1C9ADDA3244A1FBF 0x58BEA436
	...
	static void FORCE_ROOM_FOR_ENTITY(Entity entity, Any interiorID, Any p0) { invoke<Void>(0x52923C4710DD9907, entity, interiorID, p0); } // 0x52923C4710DD9907 0x10BD4435
	...
	static int GET_INTERIOR_FROM_ENTITY(Entity p0) { return invoke<int>(0x2107BA504071A6BB, p0); } // 0x2107BA504071A6BB 0x5C644614
	static void _0x82EBB79E258FA2B7(Entity entity, int id) { invoke<Void>(0x82EBB79E258FA2B7, entity, id); } // 0x82EBB79E258FA2B7 0xE645E162
	...
	static Cam CREATE_CAMERA(char* camName, BOOL p1) { return invoke<Cam>(0x5E3CF89C6BCCA67D, camName, p1); } // 0x5E3CF89C6BCCA67D 0x5D6739AE
	static Cam CREATE_CAMERA_WITH_PARAMS(char* camName, float p1, float p2, float p3, float p4, float p5, float p6, float p7, BOOL p8, Any p9) { return invoke<Cam>(0x6ABFA3E16460F22D, camName, p1, p2, p3, p4, p5, p6, p7, p8, p9); } // 0x6ABFA3E16460F22D 0x0688BE9A
	...
	static void ANIMATED_SHAKE_CAM(int cam, char* p1, char* p2, char* p3, float amplitude) { invoke<Void>(0xA2746EEAE3E577CD, cam, p1, p2, p3, amplitude); } // 0xA2746EEAE3E577CD 0xE1168767
	static BOOL IS_CAM_SHAKING(int cam) { return invoke<BOOL>(0x6B24BFE83A2BE47B, cam); } // 0x6B24BFE83A2BE47B 0x0961FD9B
	static void SET_CAM_SHAKE_AMPLITUDE(int cam, float amplitude) { invoke<Void>(0xD93DB43B82BC0D00, cam, amplitude); } // 0xD93DB43B82BC0D00 0x60FF6382
	static void STOP_CAM_SHAKING(int cam, BOOL p1) { invoke<Void>(0xBDECF64367884AC3, cam, p1); } // 0xBDECF64367884AC3 0x40D0EB87
	...
	static BOOL PLAY_CAM_ANIM(int cam, char* animName, char* animDictionary, float x, float y, float z, float xRot, float yRot, float zRot, BOOL p9, int p10) { return invoke<BOOL>(0x9A2D0FB2E7852392, cam, animName, animDictionary, x, y, z, xRot, yRot, zRot, p9, p10); } // 0x9A2D0FB2E7852392 0xBCEFB87E
	...
	static void SET_PED_CHANCE_OF_FIRING_BLANKS(Hash weaponHash, float xBias, float yBias) { invoke<Void>(0x8378627201D5497D, weaponHash, xBias, yBias); } // 0x8378627201D5497D 0xB4F44C6E
	...
	static void SET_FOCUS_ENTITY(Entity p0) { invoke<Void>(0x198F77705FA0931D, p0); } // 0x198F77705FA0931D 0x18DB04AC
	...
	static int _SET_NOTIFICATION_MESSAGE_CLAN_TAG_2(char* picName1, char* picName2, BOOL flash, int iconType1, char* sender, char* subject, float duration, char* clanTag, int iconType2) { return invoke<int>(0x531B84E7DA981FB6, picName1, picName2, flash, iconType1, sender, subject, duration, clanTag, iconType2); } // 0x531B84E7DA981FB6 0xDEB491C8
	...
	static Any _DRAW_NOTIFICATION2(BOOL p0, BOOL p1) { return invoke<Any>(0xF020C96915705B3A, p0, p1); } // 0xF020CIS_PLAYER_PLAYING96915705B3A 0x8E319AB8
	...
	static void _DRAW_TOOLTIP_NOTIFICATION(Any p0, BOOL loop, BOOL beep, int shape) { invoke<Void>(0x238FFE5C7B0498A6, p0, loop, beep, shape); } // 0x238FFE5C7B0498A6 0xB59B530D
	...
	static int _0x43E4111189E54F0E(Any* p0) { return invoke<int>(0x43E4111189E54F0E, p0); } // 0x43E4111189E54F0E 0x7DBC0764
	...
	static void _0x74513EA3E505181E(int blip, BOOL toggle) { invoke<Void>(0x74513EA3E505181E, blip, toggle); } // 0x74513EA3E505181E 0x3DCF0092
	static void _0x5FBCA48327B914DF(Any p0, BOOL p1) { invoke<Void>(0x5FBCA48327B914DF, p0, p1); } // 0x5FBCA48327B914DF 0xD1C3D71B
	static void _0xB81656BC81FE24D1(int blip, BOOL toggle) { invoke<Void>(0xB81656BC81FE24D1, blip, toggle); } // 0xB81656BC81FE24D1 0x8DE82C15
	static void _0x23C3EB807312F01A(int blip, BOOL toggle) { invoke<Void>(0x23C3EB807312F01A, blip, toggle); } // 0x23C3EB807312F01A 0x4C8F02B4
	...
	static void _0x2B6D467DAB714E8D(int blip, BOOL toggle) { invoke<Void>(0x2B6D467DAB714E8D, blip, toggle); } // 0x2B6D467DAB714E8D 0xC575F0BC
	...
	static void _SET_FAR_SHADOWS_SUPPRESSED(BOOL p0) { invoke<Void>(0x80ECBC0C856D3B0B, p0); } // 0x80ECBC0C856D3B0B 0xFE903D0F
	...
	static BOOL _START_PARTICLE_FX_NON_LOOPED_AT_COORD_2(char* effectName, float x, float y, float z, float xRot, float yRot, float zRot, float scale, BOOL p8, BOOL p9, BOOL p10) { return invoke<BOOL>(0xF56B8137DF10135D, effectName, x, y, z, xRot, yRot, zRot, scale, p8, p9, p10); } // 0xF56B8137DF10135D
	...
	static BOOL DOES_PARTICLE_FX_LOOPED_EXIST(Any ptfxHandle) { return invoke<BOOL>(0x74AFEF0D2E1E409B, ptfxHandle); } // 0x74AFEF0D2E1E409B 0xCBF91D2A
	...
	static void _SET_PTFX_ASSET_OLD_2_NEW(char* Old, char* New) { invoke<Void>(0xEA1E2D93F6F75ED9, Old, New); } // 0xEA1E2D93F6F75ED9
	...
	static void _TOGGLE_SNOW_PED_FOOT_TRACKS(BOOL toggle) { invoke<Void>(0xAEEDAD1420C65CC0, toggle); } // 0xAEEDAD1420C65CC0
	static void _TOGGLE_SNOW_VEHICLE_TRACKS(BOOL toggle) { invoke<Void>(0x4CC7F0FEA5283FE0, toggle); } // 0x4CC7F0FEA5283FE0
	...
	static void DRAW_TV_CHANNEL(float posX, float posY, float p2, float p3, float p4, int r, int g, int b, int a) { invoke<Void>(0xFDDC2B4ED3C69DF0, posX, posY, p2, p3, p4, r, g, b, a); } // 0xFDDC2B4ED3C69DF0 0x8129EF89
	...
	static Any STAT_CLEAR_SLOT_FOR_RELOAD(Any p0) { return invoke<Any>(0xEB0A72181D4AA4AD, p0); } // 0xEB0A72181D4AA4AD 0x84BDD475
	...
	static void ADVANCE_CLOCK_TIME_TO(Any p0, Any p1, Any p2) { invoke<Void>(0xC8CA9670B9D83B3B, p0, p1, p2); } // 0xC8CA9670B9D83B3B 0x57B8DA7C
	...
	static void SET_ROADS_IN_AREA(float p0, float p1, float p2, float p3, float p4, float p5, BOOL p6, BOOL p7) { invoke<Void>(0xBF1A602B5BA52FEE, p0, p1, p2, p3, p4, p5, p6, p7); } // 0xBF1A602B5BA52FEE 0xEBC7B918
	...
	static BOOL _0xAF50DA1A3F8B1BA4(int* p0) { return invoke<BOOL>(0xAF50DA1A3F8B1BA4, p0); } // 0xAF50DA1A3F8B1BA4 0xA520B982
	...
	static Any NETWORK_SEND_TEXT_MESSAGE(char* message, int* playerId) { return invoke<Any>(0x3A214F2EC889B100, message, playerId); } // 0x3A214F2EC889B100 0xAFFEA720
	...
	static BOOL NETWORK_DO_TRANSITION_TO_FREEMODE(Any* p0, Any p1, BOOL p2, int players) { return invoke<BOOL>(0x3AAD8B2FCA1E289F, p0, p1, p2, players); } // 0x3AAD8B2FCA1E289F 0xC7CB8ADF
	...
	static int* NETWORK_IS_IN_SPECTATOR_MODE() { return invoke<int*>(0x048746E388762E11); } // 0x048746E388762E11 0x3EAD9DB8
	...
	static BOOL _0xE5608CA7BC163A5F(char* p0, char* p1, Any* p2) { return invoke<BOOL>(0xE5608CA7BC163A5F, p0, p1, p2); } // 0xE5608CA7BC163A5F 0x41E8912A
	...
	static BOOL _0x40FCE03E50E8DBE8(Any p0, Any p1, int* p2) { return invoke<BOOL>(0x40FCE03E50E8DBE8, p0, p1, p2); } // 0x40FCE03E50E8DBE8
	...
	static Any _0x46E2B844905BC5F0(Any* p0, Any zero) { return invoke<Any>(0x46E2B844905BC5F0, p0, zero); } // 0x46E2B844905BC5F0 0x6087C10C
	...
	static void _START_RECORDING(Any p0) { invoke<Void>(0xC3AC2FFF9612AC81, p0); } // 0xC3AC2FFF9612AC81
	static void _STOP_RECORDING_SAVE() { invoke<Void>(0x071A5197D6AFC8B3); } // 0x071A5197D6AFC8B3
	static void _STOP_RECORDING_DISCARD() { invoke<Void>(0x88BB3507ED41A240); } // 0x88BB3507ED41A240
